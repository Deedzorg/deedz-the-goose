...
export const gooseColors = Object.freeze([
  ...
  { id: 'ember', name: 'Ember', color: 0xff8a42, accent: 0xffc285 },
...
export const gooseClasses = Object.freeze([
  ...
  gooseClass({ id: 'echo', name: 'Echo Goose', ability: 'Big Honk', description: 'Longer, stronger honks with a quicker recharge.', tradeoff: 'Less health and weaker crumb throws', themeColor: 0x55d6ff, stats: stats({ health: 5, honkRange: 1.3, honkStrength: 1.1, honkCooldown: 0.88, throwStrength: 0.92 }), ratings: { health: 2, speed: 3, honk: 5, throw: 2, flight: 3 } }),
  gooseClass({ id: 'ranger', name: 'Crumb Ranger', ability: 'Long Toss', description: 'Charged crumbs travel farther, higher, and stay airborne longer.', tradeoff: 'Less health, shorter honk, slower dash recharge', themeColor: 0xffd95a, stats: stats({ health: 5, throwStrength: 1.25, throwLift: 1.12, throwDuration: 1.18, honkRange: 0.88, dashCooldown: 1.08 }), ratings: { health: 2, speed: 3, honk: 2, throw: 5, flight: 3 } }),
  gooseClass({ id: 'guardian', name: 'Guardian Goose', ability: 'Sturdy', description: 'Eight hearts make this goose the safest frontline choice.', tradeoff: 'Slower movement, acceleration, and dash', themeColor: 0x7dff8a, stats: stats({ health: 8, speed: 0.88, acceleration: 0.9, dashSpeed: 0.9 }), ratings: { health: 5, speed: 2, honk: 3, throw: 3, flight: 3 } }),
  gooseClass({ id: 'skywing', name: 'Skywing Goose', ability: 'Long Glide', description: 'Third-jump flight lasts dramatically longer.', tradeoff: 'Less health, slower movement, weaker honk and dash', themeColor: 0xb794ff, stats: stats({ health: 5, speed: 0.94, flightDuration: 1.7, dashSpeed: 0.9, honkStrength: 0.9 }), ratings: { health: 2, speed: 2, honk: 2, throw: 3, flight: 5 } }),
  gooseClass({ id: 'swift', name: 'Swift Goose', ability: 'Quick Dash', description: 'Faster running, acceleration, and a stronger, quicker dash.', tradeoff: 'Less health, shorter honk, weaker throws and glide', themeColor: 0xff7fbe, stats: stats({ health: 5, speed: 1.15, acceleration: 1.12, dashSpeed: 1.15, dashCooldown: 0.82, honkRange: 0.88, throwStrength: 0.9, flightDuration: 0.9 }), ratings: { health: 2, speed: 5, honk: 2, throw: 2, flight: 2 } }),
  gooseClass({ id: 'spring', name: 'Spring Goose', ability: 'High Flap', description: 'Every jump launches higher, making vertical routes easier.', tradeoff: 'Less health, slower running, shorter third-jump flight', themeColor: 0xff8a42, stats: stats({ health: 5, speed: 0.94, jumpSpeed: 1.14, flightDuration: 0.85, dashCooldown: 1.06 }), ratings: { health: 2, speed: 2, honk: 3, throw: 3, flight: 4 } }),
]);
