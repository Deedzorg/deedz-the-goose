...
export const gooseClasses = Object.freeze([
  ...
  gooseClass({ id: 'guardian', name: 'Guardian Goose', ability: 'Sturdy', description: 'Eight hearts make this goose the safest frontline choice.', tradeoff: 'Slower movement, acceleration, and dash', themeColor: 0x7dff8a, stats: stats({ health: 8, speed: 0.9, acceleration: 0.92, dashSpeed: 0.9, flightDuration: 0.9 }), ratings: { health: 5, speed: 2, honk: 3, throw: 3, flight: 2 } }),
  ...
  gooseClass({ id: 'swift', name: 'Swift Goose', ability: 'Quick Dash', description: 'Faster running, acceleration, and a stronger, quicker dash.', tradeoff: 'Less health, shorter honk, weaker throws and glide', themeColor: 0xff7fbe, stats: stats({ health: 5, speed: 1.12, acceleration: 1.1, dashSpeed: 1.15, dashCooldown: 0.85, honkRange: 0.9 }), ratings: { health: 2, speed: 5, honk: 2, throw: 3, flight: 3 } }),
